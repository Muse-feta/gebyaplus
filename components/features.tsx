...
export default function Features() {
  ...
  const [baseColor, setBaseColor] = useState<[number, number, number]>([
    1.0, 0.0, 0.314,
  ]); // #FF0050 in RGB normalized
  const [glowColor, setGlowColor] = useState<[number, number, number]>([
    0.145, 0.957, 0.933,
  ]); // #25F4EE in RGB normalized

  const [dark, setDark] = useState<number>(theme === "dark" ? 1 : 0);

  useEffect(() => {
    setBaseColor([1.0, 0.0, 0.314]); // #FF0050
    setGlowColor([0.145, 0.957, 0.933]); // #25F4EE
            ...
            <div className="grid grid-cols-12 gap-4 justify-center">
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="flex items-center gap-8">
                        ...
                        >
                          <div className="w-full h-full bg-gradient-to-br from-[#FF0050] to-[#25F4EE] flex items-center justify-center">
                            <svg
                  ...
                  <h1 className="mt-8 text-center text-5xl leading-[100%] font-semibold sm:leading-normal lg:mt-12 lg:text-6xl">
                    <span className='bg-background relative mt-3 inline-block w-fit rounded-md border px-1.5 py-0.5 before:absolute before:top-0 before:left-0 before:z-10 before:h-full before:w-full before:bg-[url("/noise.gif")] before:opacity-[0.09] before:content-[""]'>
                      <ScrambleHover
                        ...
                        className="cursor-pointer bg-gradient-to-t from-[#FF0050] to-[#25F4EE] bg-clip-text text-transparent"
                    ...
                    <div className="relative rounded-2xl border border-white/10 bg-black/20 dark:bg-white/5 backdrop-blur-sm">
                      ...
                      <div className="flex items-center justify-between px-4 pb-4">
                        <div className="flex items-center gap-3">
                          <button className="flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-[#FF0050] to-[#25F4EE] hover:from-[#FF0050]/90 hover:to-[#25F4EE]/90 transition-colors text-white font-medium">
                            <svg
              ...
              <motion.div
                ...
                whileHover={{
                  rotateY: 5,
                  rotateX: 2,
                  boxShadow: "0 20px 40px rgba(255, 0, 80, 0.3)",
                  borderColor: "rgba(255, 0, 80, 0.6)",
                }}
                style={{ transition: "all 0s ease-in-out" }}
              >
                ...
                <div className="flex grow items-center justify-center select-none relative min-h-[300px] p-4">
                  <div className="relative w-full max-w-sm">
                    <img
                      ...
                      alt="Content Performance Dashboard"
